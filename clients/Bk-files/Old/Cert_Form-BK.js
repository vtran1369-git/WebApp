...
import SimpleTableNoHeader from '../Utils/SimpleTable-NoHeader'
...
export default function App(props) {
    ...
    const id = props.id
    console.log(">>CertForm, props.id: ", props.id)
    console.log(">>CertForm, props.value: ", props.value)
        ...
        <>  
            <MuiThemeProvider theme={theme}>
                <Grid container xs="12" className="form-main" spacing={0} direction="row" justify="left" alignItems="stretch">
                    <Grid item xs={12} className="form-container cert" id="cert-form" style={{ fontSize: "0.705em" }} >
                        ...
                        <Grid container xs="12" spacing={0} direction="row" justify="center" alignItems="stretch" style={{marginTop: "5px"}}>
                            ...
                            <Grid item xs={4}  className="form-control"> 
                                <Grid container spacing={0} className="grid-line">
                                    ...
                                    {/* <SimpleTableNoHeader rows={certId_rows} /> */}
                                </Grid>  
                            </Grid>
                        </Grid> 
