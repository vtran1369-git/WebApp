      ...
      (data) => {
       /*  alert("login successful!")
        ...
        if((data.role === role ) || (data.role === "Admin")){
          ...
          let signedUsers = ""
          if(signed != null)
            { signedUsers = signed + "," + role }
          else{ signedUsers = role }
        
          console.log("signedUser: ", signedUsers)
          setSigned(signedUsers)
          
          if(role === "Tech" && edited === "no"){ console.log("role=Tech & edited=no"); setStatus("New")}
          else if(role === "Tech" && edited === "yes"){console.log("role=Tech & edited=yes"); setStatus("Edited")}
          else if(role === "QA"){console.log("role=QA"); setStatus("In progress")}
          else if(role === "FinalQA"){console.log("role=FinalQA"); setStatus("Completed")}
          else{ console.log("role is not Tech, QA or FinalQA")}
        }
        else{
