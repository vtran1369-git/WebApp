...
const Register = (props) => {
  ...
  const handleUpdate = () =>{
    ...
    if (checkBtn.current.context._errors.length === 0) {
      ...
      AuthServiceAdmin.update(role, firstname, lastname, username, email, password).then(
        (response) => {
          setMessage(response.data.message);
          setSuccessful(true);
        },
    ...
    <div className="col-md-12">
      <div className="card card-container">
        <img
          ...
          // src="clients/src/views/avatar_2x.png"
          alt="profile-img"
            ...
            <div>
              <div className="form-group">
                ...
                <select name="role" onChange={onChangeRole}>
                  <option defaultValue="Tech">Technician</option>
                  <option value="QA">QA</option>
                  <option value="FinalQA">Final QA</option>
              ...
              <div className="form-group">
                ...
                <button style={{marginLeft: 25}} className="btn btn-primary btn-block" onClick={handleUpdate}>Profile Update</button>
              </div>
            </div>
          )}
